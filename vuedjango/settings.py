...
SECRET_KEY = 'dh!@8+iaysw7+xb+5n!nrra_mj7unz&)bu*#%mnu#!ox9t74fe'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost ', '.MixedIndex.com']
...
HAYSTACK_CONNECTIONS = {
    'default':{
        ...
        "URL": "http://127.0.0.1:9200/",# 此处为elasticseaech运行的服务器ip地址，端口号为默认的9200
